...
namespace Test
{
    ...
    class TestNewSkillFirefox
    {
        ...
        {
            firefoxDriver = new FirefoxDriver("C:/Webdrivers");
            firefoxDriver.Navigate().GoToUrl("https://localhost:44334/");
            //sleep();
            //firefoxDriver.FindElement(By.Id("advancedButton")).Click();
            //firefoxDriver.FindElement(By.Id("exceptionDialogButton")).Click();
